...
//            .setProxy(HttpHost("127.0.0.1", 5533))
            ...
            try {
                ...
                try {
                    closeableHttpClient.execute(httpRequestBase).use {
                        ...
                        responseEntity.cookies = store.cookies.stream().collect(
                            Collectors.toMap(
                                { obj: Cookie -> obj.name },
                    ...
                    logger(LogLevel.WARN) { e.cause.toString() }
                }
    ...
    class ResponseEntity {
        ...
        fun getHeaders(headerName: String): String {
